...
function optionsframework_options() {
	...
	$options[] = array(
		...
		'std' => '&copy; 2015 Avanter Inc.',
		'type' => 'textarea');
	
	
	$options[] = array(
		'name' => __('Map Address on Contact Page', 'progression'),
		'desc' => __('Choose your map address for the contact page template map. ', 'progression'),
		'id' => 'contact_map_text',
		'std' => 'Santa Rosa, CA',
		'type' => 'text');
	...
	$options[] = array(
		'name' => __('Shop/Portfolio', 'progression'),
		'type' => 'heading');
	...
	$options[] = array(
		...
		'id' => 'shop_sidebar_display',
		'std' => '1',
		'type' => 'checkbox');
	

	$options[] = array(
		'name' => __('Display Sidebar on Shop Product Pages', 'progression'),
		'desc' => __('Select this checkbox to display the sidebar on the Shop Index and Product Pages.', 'progression'),
		'id' => 'shop_single_sidebar_display',
		'std' => '1',
		'type' => 'checkbox');
	...
	$options[] = array(
		...
		'desc' => __('Choose your logo width in pixels.  Default is 377.', 'progression'),
		'id' => 'logo_width',
		'std' => '377',
		'class' => 'mini',
		'type' => 'text');
	...
	$options[] = array(
		...
		'desc' => __('Increase this number to make the navigation taller or shorter.  Use this to ensure the navigation stays the full height of the top bar.  Default is 54.', 'progression'),
